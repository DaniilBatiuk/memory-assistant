...
export const GetInTouch: React.FC = async () => {
  ...
  return (
    <section>
      <div className='flex flex-col items-center adaptive-margin-bottom-25-30 adaptive-row-gap-10-15'>
      ...
      <div className='flex adaptive-gap-20-30 max-[930px]:flex-col max-[930px]:items-center'>
        <div className='flex w-1/3 flex-col max-[930px]:w-full max-[930px]:items-center'>
          {ICONS.email()}
